...
namespace Ictshop.Areas.Admin.Controllers
{
    public class LoaispsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Hedieuhanh hedieuhanh = db.Loaisp.Find(id);
            if (hedieuhanh == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Maloai,Tenloai")] Hedieuhanh hedieuhanh)
        {
            if (ModelState.IsValid)
            {
                db.Loaisp.Add(hedieuhanh);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Maloai,Tenloai")] Hedieuhanh hedieuhanh)
        {
            if (ModelState.IsValid)
            {
