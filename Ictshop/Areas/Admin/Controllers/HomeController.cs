...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create()
        {
            ...
            var hangselected = new SelectList(db.Nhacungcaps, "Mancc", "Tenncc");
            ViewBag.Mancc = hangselected;
            var hdhselected = new SelectList(db.Loaisp, "Maloai", "Tenloai");
        ...
        public ActionResult Edit(int id)
        {
            ...
            var dt = db.Sanphams.Find(id);
            var hangselected = new SelectList(db.Nhacungcaps, "Mancc", "Tenncc",dt.Mancc);
            ViewBag.Mancc = hangselected;
            var hdhselected = new SelectList(db.Loaisp, "Maloai", "Tenloai", dt.Maloai);
            ViewBag.Maloai = hdhselected;
           // 
            return View(dt);
