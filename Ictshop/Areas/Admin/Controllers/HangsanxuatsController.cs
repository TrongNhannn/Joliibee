...
namespace Ictshop.Areas.Admin.Controllers
{
    public class HangsanxuatsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Nhacungcap hangsanxuat = db.Nhacungcaps.Find(id);
            if (hangsanxuat == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Mancc,Tenncc")] Nhacungcap hangsanxuat)
        {
            if (ModelState.IsValid)
            {
                db.Nhacungcaps.Add(hangsanxuat);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Mancc,Tenncc")] Nhacungcap hangsanxuat)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Nhacungcap hangsanxuat = db.Nhacungcaps.Find(id);
            db.Nhacungcaps.Remove(hangsanxuat);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
